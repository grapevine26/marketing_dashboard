...
export default function Theme1GraphiteBlue() {
  return (
    <div className="bg-[#090A0C] text-zinc-100 p-6 sm:p-8 rounded-3xl border border-[#22242A] space-y-6 font-sans shadow-2xl">
      {/* Top Banner */}
      <div className="p-6 rounded-2xl bg-gradient-to-r from-[#141A29] via-[#10131A] to-[#121624] border border-[#222B3D] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold">
            ...
            <span>1. 흑연 + 일렉트릭 블루 (Electric Blue & Ice)</span>
          </div>
          <h2 className="text-xl font-bold text-zinc-100">통합 마케팅 오버뷰 & 전체 일정</h2>
          <p className="text-xs text-zinc-400">
            Vercel / Linear 감성: 가장 정갈하고 신뢰감이 높으며 눈이 시리지 않은 모던 블루.
          </p>
        </div>
        <div className="flex gap-2">
          <button className="px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold transition shadow-sm">
            + 새 시딩
          </button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl bg-[#131418] border border-[#22242A] hover:border-blue-500/40 transition space-y-3">
        ...
        <div className="p-5 rounded-2xl bg-[#131418] border border-[#22242A] hover:border-indigo-500/40 transition space-y-3">
          <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-2xl bg-[#131418] border border-[#22242A] hover:border-sky-500/40 transition space-y-3">
          <div className="flex items-center justify-between">
