...
export default function Theme3GraphiteAmber() {
  return (
    <div className="bg-[#090A0C] text-zinc-100 p-6 sm:p-8 rounded-3xl border border-[#22242A] space-y-6 font-sans shadow-2xl">
      {/* Top Banner */}
      <div className="p-6 rounded-2xl bg-gradient-to-r from-[#211A11] via-[#14120E] to-[#1C170F] border border-[#3D301E] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-semibold">
            ...
            <span>3. 흑연 + 웜 앰버 골드 (Warm Amber & Copper Gold)</span>
          </div>
          <h2 className="text-xl font-bold text-zinc-100">통합 마케팅 오버뷰 & 전체 일정</h2>
          <p className="text-xs text-zinc-400">
            따뜻하고 부드러운 앰버 골드: 눈부심이 전혀 없고 가독성이 가장 안정적인 골드톤.
          </p>
        </div>
        <div className="flex gap-2">
          <button className="px-3.5 py-2 rounded-xl bg-amber-600 hover:bg-amber-500 text-white text-xs font-bold transition shadow-sm">
            + 새 시딩
          </button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-[#131418] border border-[#22242A] hover:border-orange-500/40 transition space-y-3">
          <div className="flex items-center justify-between">
            <div className="w-9 h-9 rounded-xl bg-orange-500/10 text-orange-400 flex items-center justify-center">
              <PartyPopper className="w-4 h-4" />
            </div>
            <span className="text-xs text-orange-400 font-semibold">관리 →</span>
          </div>
          <div>
        ...
        <div className="p-5 rounded-2xl bg-[#131418] border border-[#22242A] hover:border-yellow-500/40 transition space-y-3">
          <div className="flex items-center justify-between">
            <div className="w-9 h-9 rounded-xl bg-yellow-500/10 text-yellow-400 flex items-center justify-center">
              <Camera className="w-4 h-4" />
            </div>
            <span className="text-xs text-yellow-400 font-semibold">관리 →</span>
          </div>
          <div>
      ...
      <div className="p-6 rounded-2xl bg-[#131418] border border-[#22242A] space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1 bg-[#090A0C] p-1 rounded-xl border border-[#22242A] text-xs">
            <span className="px-2.5 py-1 rounded-lg bg-amber-600 text-white font-semibold">전체</span>
        ...
        <div className="space-y-2">
          <div className="p-3.5 rounded-xl bg-[#090A0C] border border-[#22242A] flex items-center justify-between">
            ...
            <span className="font-mono text-xs text-amber-400 font-semibold">2026-09-10 (D-3)</span>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-[#090A0C] border border-[#22242A] flex items-center justify-between">
            ...
            <span className="font-mono text-xs text-orange-400 font-semibold">2026-09-15 18:00</span>
          </div>
        </div>
      </div>
    </div>
