  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 font-sans">
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-semibold text-text-2">캠페인명 *</label>
        <input
          type="text"
          required
          value={name}
          ...
          className="w-full px-4 py-2.5 rounded-xl bg-bg border border-border text-text text-xs focus:outline-none focus:border-blue-500"
        />
      </div>

      <div className="space-y-1.5">
        <label className="text-xs font-semibold text-text-2">광고주 / 브랜드명 *</label>
        <input
          type="text"
          required
          value={companyName}
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-semibold text-text-2">캠페인 유형 *</label>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <label
            className={`p-4 rounded-2xl border cursor-pointer flex items-center gap-3 transition ${
              campaignType === "shipping"
                ...
                : "bg-bg border-border hover:border-border text-text-sub"
            }`}
          >
            <input
              type="radio"
            ...
            <div>
              ...
              <div className="text-[10px] text-text-sub mt-0.5">제품 택배 발송 및 후기 수집</div>
            </div>
          </label>
          ...
          >
            ...
            <div>
              ...
              <div className="text-[10px] text-text-sub mt-0.5">매장/팝업 방문 일정 조율 및 행사 연계</div>
            </div>
          </label>
        </div>
      </div>
