    ...
    <div className="max-w-5xl mx-auto space-y-10 font-sans pb-16">
      ...
      <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-surface via-surface2 to-sidebar border border-border space-y-4 shadow-2xl relative overflow-hidden">
        ...
        <div className="pt-2 flex flex-wrap gap-2.5">
          ...
          <a
            href="#seeding"
            className="px-4 py-2 rounded-xl bg-surface2 hover:bg-surface3 border border-border text-text text-xs font-semibold transition"
          >
            1. 인플루언서 시딩 5단계
          </a>
          <a
      ...
      <section id="quick-start" className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-text">🚀 빠른 시작 (Quick Start)</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-5 rounded-2xl bg-surface border border-border space-y-2.5">
            ...
            <h3 className="text-sm font-bold text-text">체험단 시딩이 필요할 때</h3>
          ...
          <div className="p-5 rounded-2xl bg-surface border border-border space-y-2.5">
            ...
            <h3 className="text-sm font-bold text-text">행사/팝업 초청이 필요할 때</h3>
            <p className="text-xs text-text-sub leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-surface border border-border space-y-2.5">
            ...
            <h3 className="text-sm font-bold text-text">SNS 공식 채널을 운영할 때</h3>
            <p className="text-xs text-text-sub leading-relaxed">
      ...
      <section id="seeding" className="space-y-6 pt-6 border-t border-border">
        <div className="space-y-1">
          ...
          <h2 className="text-xl font-bold text-text">1. 인플루언서 시딩 5단계 워크플로우 완벽 가이드</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="p-5 rounded-2xl bg-surface border border-border space-y-3">
            ...
            <div className="text-xs text-text-2 space-y-1.5 pl-8.5">
      ...
      <section id="events" className="space-y-6 pt-6 border-t border-border">
        <div className="space-y-1">
          ...
          <h2 className="text-xl font-bold text-text">2. 인플루언서 행사 완벽 가이드</h2>
          <p className="text-xs text-text-sub">
      ...
      <section id="sns" className="space-y-6 pt-6 border-t border-border">
        <div className="space-y-1">
          ...
          <h2 className="text-xl font-bold text-text">3. SNS 공식 채널 대행 운영 완벽 가이드</h2>
          <p className="text-xs text-text-sub">
        ...
        <div className="space-y-4">
          <div className="p-5 rounded-2xl bg-surface border border-border space-y-2.5">
            <h3 className="text-sm font-bold text-text">📌 핵심 운영 프로세스</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-text-2 pt-1">
      ...
      <section id="overview" className="space-y-6 pt-6 border-t border-border">
        <div className="space-y-1">
          ...
          <h2 className="text-xl font-bold text-text">4. 통합 대시보드 & 캘린더 활용법</h2>
          <p className="text-xs text-text-sub">
      ...
      <section className="space-y-6 pt-6 border-t border-border">
        <div className="space-y-1">
          ...
          <h2 className="text-xl font-bold text-text">5. 환경설정 및 템플릿 커스텀</h2>
        </div>
