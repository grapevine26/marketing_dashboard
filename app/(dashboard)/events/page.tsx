    ...
    <div className="space-y-6 max-w-6xl mx-auto font-sans">
      ...
      <div className="p-4 rounded-2xl bg-[#131418] border border-[#22242A] space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          {campaigns.map((c) => (
            <Link key={c.id} href={`/campaigns/${c.id}/events`} className="px-3 py-1.5 rounded-xl bg-[#090A0C] hover:bg-[#181A20] border border-[#22242A] text-xs text-zinc-200 inline-flex items-center gap-1.5 transition">
            ...
            >
              ...
              <div className="pt-3 border-t border-[#22242A] flex items-center justify-between text-xs text-zinc-400">
                <div className="flex items-center gap-3 font-mono tabular-nums">
                  <span>초청 <strong className="text-zinc-200">{inviteeCount}</strong></span>
