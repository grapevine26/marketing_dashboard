...
export default function CheckinList({
  ...
  return (
    <div className="space-y-4">
      <div className="p-4 rounded-2xl bg-blue-950/40 border border-blue-900/50 flex items-center justify-between text-xs">
        <span>현재 입장 완료 인원:</span>
      ...
      <div className="relative">
        <input
          ...
          className="w-full pl-10 pr-4 py-3 rounded-2xl bg-slate-900 border border-slate-700 text-white text-sm focus:outline-none focus:border-blue-500"
        />
        ...
        {filtered.map((g) => (
          ...
          >
            <div className="space-y-0.5">
              ...
              <div className="text-xs font-mono text-slate-400">{g.contact}</div>
            </div>
