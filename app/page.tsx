    ...
    <div className="min-h-screen flex bg-[#090A0C] text-zinc-100 font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        <main className="flex-1 p-6 md:p-8 max-w-7xl w-full mx-auto space-y-8">
          {/* Top Banner */}
          <div className="p-8 rounded-3xl bg-gradient-to-r from-[#141A29] via-[#10131A] to-[#121624] border border-[#222B3D] flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-2xl">
            ...
            <div className="flex flex-wrap gap-2.5">
              ...
              <Link
                href="/events"
                className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md transition"
              >
                + 새 행사
              </Link>
              <Link
                href="/sns"
                className="px-4 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-500 text-white text-xs font-bold shadow-md transition"
              >
                + 새 SNS
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Link
              href="/campaigns"
              className="p-5 rounded-3xl bg-[#131418] border border-[#22242A] hover:border-blue-500/40 transition space-y-3 group"
            >
            ...
            <Link
              href="/events"
              className="p-5 rounded-3xl bg-[#131418] border border-[#22242A] hover:border-indigo-500/40 transition space-y-3 group"
            >
              <div className="flex items-center justify-between">
            ...
            <Link
              href="/sns"
              className="p-5 rounded-3xl bg-[#131418] border border-[#22242A] hover:border-sky-500/40 transition space-y-3 group"
            >
              <div className="flex items-center justify-between">
                <div className="w-10 h-10 rounded-2xl bg-sky-500/10 text-sky-400 flex items-center justify-center">
                  <Camera className="w-5 h-5" />
                </div>
                <span className="text-xs text-sky-400 font-semibold group-hover:translate-x-0.5 transition flex items-center gap-0.5">
                  관리 <ArrowRight className="w-3.5 h-3.5" />
                </span>
              </div>
              <div>
