    ...
    <div className="min-h-screen bg-[#090A0C] text-zinc-100 flex flex-col items-center justify-center p-4 sm:p-6 md:p-10 font-sans">
      <div className="w-full max-w-2xl bg-[#131418] border border-[#22242A] rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl">
        <div className="text-center space-y-3 pb-5 border-b border-[#22242A]">
          <div className="w-14 h-14 rounded-2xl bg-[#090A0C] border border-[#22242A] flex items-center justify-center mx-auto shadow-inner">{icon}</div>
          ...
          <div className="space-y-1">
            <h1 className="text-xl sm:text-2xl font-extrabold text-zinc-100 tracking-tight">{account.company_name} SNS 사전설문</h1>
            <p className="text-xs font-mono text-zinc-400">@{account.handle}</p>
          </div>
